...
app.controller('ConsoleController', ['$scope', '$rootScope', '$state', '$timeout', '$stateParams', '$sce', 'BlackjackService', 'DataService', 'ActionService', 'ItemService', 'InventoryService', 'GenerateService',
    function( $scope, $rootScope, $state, $timeout, $stateParams, $sce, BlackjackService, DataService, ActionService, ItemService, InventoryService, GenerateService ){
